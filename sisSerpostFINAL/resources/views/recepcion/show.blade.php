...
<div class="row">
    <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
            <div class="form-group">
            <a href="crear_reporte_envio_encomienda/1"><button class="btn btn-primary" >Ver Reporte</button></a>
            <a href="crear_reporte_envio_encomienda/1"><button class="btn btn-success" >Descargar</button></a>      
