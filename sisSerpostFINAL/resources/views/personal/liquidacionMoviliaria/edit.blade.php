...
@section ('contenido')
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3>Agregar Detalle liquidacion </h3>
            @if (count($errors)>0)
  ...
  {!!Form::model($liquidacion,['method'=>'PATCH','route'=>['liquidacionMoviliaria.update',$liquidacion->idliquidacion_movilidad]])!!} {{Form::token()}}
            <!-- token-->
    <div class="row">

        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                <label for="pidpersona">Trabajador</label>
                <input type="text"  name="pidpersona"  class="form-control" value="{{$liquidacion->idpersona}}">
            </div>
        </div>
   </div>
  <div class="row">
